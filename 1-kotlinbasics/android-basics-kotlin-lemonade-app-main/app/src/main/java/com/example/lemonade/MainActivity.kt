...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setViewElements(getString(R.string.lemon_select),R.drawable.lemon_tree)
    ...
    private fun clickLemonImage() {
        ...
        if (lemonadeState == SELECT) {
            ...
            squeezeCount = 0
            setViewElements(getString(R.string.lemon_squeeze),R.drawable.lemon_squeeze)
        ...
        //  - Additionally, lemonSize is no longer relevant and should be set to -1
            ...
            if (lemonSize == 0) {
                lemonadeState = DRINK
                lemonSize = -1
                setViewElements(getString(R.string.lemon_drink),R.drawable.lemon_drink)
            }
        }
        // TODO: When the image is clicked in the DRINK state the state should become RESTART
        else if (lemonadeState == DRINK) {
            lemonadeState = RESTART
            setViewElements(getString(R.string.lemon_empty_glass),R.drawable.lemon_restart)
        }
     ...
     */
    private fun setViewElements(text: String, imageID: Int) {
