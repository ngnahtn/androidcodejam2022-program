...
class WordAdapter(private val letterId: String, context: Context) :
    ...
    var onButtonListener: OnWordButtonListener? = null
    ...
    override fun onBindViewHolder(holder: WordViewHolder, position: Int) {
        ...
        holder.button.setOnClickListener {
            val queryUrl = Uri.parse("${Constant.SEARCH_PREFIX}${item}")
            if (queryUrl != null) {
                onButtonListener?.onClickWordButton(queryUrl)
            }
        }
    }
...
interface OnWordButtonListener {
    fun onClickWordButton(url: Uri?)
}